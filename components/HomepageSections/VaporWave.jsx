...
// https://github.com/MaximeHeckel/linear-vaporwave-three.js
...
const Index = () => {
  ...
  useEffect(() => {
    ...
    const gridTexture = textureLoader.load("VaporWave/grid-6.png");
    const heightTexture = textureLoader.load("VaporWave/displacement-7.png");
    const metalnessTexture = textureLoader.load("VaporWave/metalness-2.png");
    ...
    spotlight.position.set(15, 0.75, 2.1);
    ...
    // effectComposer.addPass(rgbShiftPass);  // Blur
    ...
    const tick = () => {
      ...
      plane.position.z = (elapsedTime * 0.05) % 2; // speed
      plane2.position.z = ((elapsedTime * 0.05) % 2) - 2; //speed
